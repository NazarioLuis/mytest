...
class UsuarioTableMap extends TableMap
{
     ...
     */
    const COL_ALIAS = 'usuario.alias';

    /**
     * the column name for the senia field
     */
    const COL_SENIA = 'usuario.senia';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Nombre', 'Alias', 'Senia', ),
        self::TYPE_CAMELNAME     => array('id', 'nombre', 'alias', 'senia', ),
        self::TYPE_COLNAME       => array(UsuarioTableMap::COL_ID, UsuarioTableMap::COL_NOMBRE, UsuarioTableMap::COL_ALIAS, UsuarioTableMap::COL_SENIA, ),
        self::TYPE_FIELDNAME     => array('id', 'nombre', 'alias', 'senia', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Nombre' => 1, 'Alias' => 2, 'Senia' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'nombre' => 1, 'alias' => 2, 'senia' => 3, ),
        self::TYPE_COLNAME       => array(UsuarioTableMap::COL_ID => 0, UsuarioTableMap::COL_NOMBRE => 1, UsuarioTableMap::COL_ALIAS => 2, UsuarioTableMap::COL_SENIA => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'nombre' => 1, 'alias' => 2, 'senia' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('nombre', 'Nombre', 'VARCHAR', true, 80, null);
        $this->addColumn('alias', 'Alias', 'VARCHAR', true, 12, null);
        $this->addColumn('senia', 'Senia', 'VARCHAR', true, 60, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsuarioTableMap::COL_ALIAS);
            $criteria->addSelectColumn(UsuarioTableMap::COL_SENIA);
        } else {
