...
*/
abstract class Alumno implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\AlumnoTableMap';
    ...
    /**
     * Initializes internal state of Base\Alumno object.
     */
    ...
    /**
     * Compares this with another <code>Alumno</code> instance.  If
     * <code>obj</code> is an instance of <code>Alumno</code>, delegates to
     * <code>equals(Alumno)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Alumno The current object, for fluid interface
     */
     ...
     * @return $this|\Alumno The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AlumnoTableMap::COL_ID] = true;
        }
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[AlumnoTableMap::COL_NOMBRE] = true;
        }
    ...
    public function setApellido($v)
    {
        ...
        if ($this->apellido !== $v) {
            $this->apellido = $v;
            $this->modifiedColumns[AlumnoTableMap::COL_APELLIDO] = true;
        }
    ...
    public function setDocumento($v)
    {
        ...
        if ($this->documento !== $v) {
            $this->documento = $v;
            $this->modifiedColumns[AlumnoTableMap::COL_DOCUMENTO] = true;
        }
    ...
    /**
     * Set the value of [senia] column.
     * 
     * @param string $v new value
     * @return $this|\Alumno The current object (for fluent API support)
     */
    public function setSenia($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->senia !== $v) {
            $this->senia = $v;
            $this->modifiedColumns[AlumnoTableMap::COL_SENIA] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AlumnoTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AlumnoTableMap::translateFieldName('Nombre', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nombre = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AlumnoTableMap::translateFieldName('Apellido', TableMap::TYPE_PHPNAME, $indexType)];
            $this->apellido = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AlumnoTableMap::translateFieldName('Documento', TableMap::TYPE_PHPNAME, $indexType)];
            $this->documento = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AlumnoTableMap::translateFieldName('Senia', TableMap::TYPE_PHPNAME, $indexType)];
            $this->senia = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 5; // 5 = AlumnoTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Alumno'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAlumnoQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Alumno::setDeleted()
     * @see Alumno::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAlumnoQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AlumnoTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AlumnoTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AlumnoTableMap::COL_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = 'nombre';
        }
        if ($this->isColumnModified(AlumnoTableMap::COL_APELLIDO)) {
            $modifiedColumns[':p' . $index++]  = 'apellido';
        }
        if ($this->isColumnModified(AlumnoTableMap::COL_DOCUMENTO)) {
            $modifiedColumns[':p' . $index++]  = 'documento';
        }
        if ($this->isColumnModified(AlumnoTableMap::COL_SENIA)) {
            $modifiedColumns[':p' . $index++]  = 'senia';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'documento':                        
                        ...
                        break;
                    case 'senia':                        
                        $stmt->bindValue($identifier, $this->senia, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = AlumnoTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Alumno'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Alumno'][$this->hashCode()] = true;
        $keys = AlumnoTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getNombre(),
            $keys[2] => $this->getApellido(),
            $keys[3] => $this->getDocumento(),
            $keys[4] => $this->getSenia(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setDocumento($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setSenia($arr[$keys[4]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AlumnoTableMap::COL_ID)) {
            $criteria->add(AlumnoTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AlumnoTableMap::COL_NOMBRE)) {
            $criteria->add(AlumnoTableMap::COL_NOMBRE, $this->nombre);
        }
        if ($this->isColumnModified(AlumnoTableMap::COL_APELLIDO)) {
            $criteria->add(AlumnoTableMap::COL_APELLIDO, $this->apellido);
        }
        if ($this->isColumnModified(AlumnoTableMap::COL_DOCUMENTO)) {
            $criteria->add(AlumnoTableMap::COL_DOCUMENTO, $this->documento);
        }
        if ($this->isColumnModified(AlumnoTableMap::COL_SENIA)) {
            $criteria->add(AlumnoTableMap::COL_SENIA, $this->senia);
        }
    ...
    {
        $criteria = ChildAlumnoQuery::create();
        $criteria->add(AlumnoTableMap::COL_ID, $this->id);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setSenia($this->getSenia());
    ...
    public function setInscripcions(Collection $inscripcions, ConnectionInterface $con = null)
    {
        ...
        foreach ($inscripcionsToDelete as $inscripcionRemoved) {
            $inscripcionRemoved->setAlumno(null);
        }
     ...
     * @return ObjectCollection|ChildInscripcion[] List of ChildInscripcion objects
     */
    public function getInscripcionsJoinPeriodo(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildInscripcionQuery::create(null, $criteria);
        $query->joinWith('Periodo', $joinBehavior);
    ...
    public function setResultados(Collection $resultados, ConnectionInterface $con = null)
    {
        ...
        foreach ($resultadosToDelete as $resultadoRemoved) {
            $resultadoRemoved->setAlumno(null);
        }
     ...
     * @return ObjectCollection|ChildResultado[] List of ChildResultado objects
     */
    public function getResultadosJoinExamen(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildResultadoQuery::create(null, $criteria);
        $query->joinWith('Examen', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(AlumnoTableMap::DEFAULT_STRING_FORMAT);
    }
