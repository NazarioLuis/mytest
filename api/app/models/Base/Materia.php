...
*/
abstract class Materia implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MateriaTableMap';
    ...
    /**
     * Initializes internal state of Base\Materia object.
     */
    ...
    /**
     * Compares this with another <code>Materia</code> instance.  If
     * <code>obj</code> is an instance of <code>Materia</code>, delegates to
     * <code>equals(Materia)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Materia The current object, for fluid interface
     */
     ...
     * @return $this|\Materia The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[MateriaTableMap::COL_ID] = true;
        }
    ...
    public function setCarId($v)
    {
        ...
        if ($this->car_id !== $v) {
            $this->car_id = $v;
            $this->modifiedColumns[MateriaTableMap::COL_CAR_ID] = true;
        }
    ...
    public function setDescripcion($v)
    {
        ...
        if ($this->descripcion !== $v) {
            $this->descripcion = $v;
            $this->modifiedColumns[MateriaTableMap::COL_DESCRIPCION] = true;
        }
    ...
    public function setObservacion($v)
    {
        ...
        if ($this->observacion !== $v) {
            $this->observacion = $v;
            $this->modifiedColumns[MateriaTableMap::COL_OBSERVACION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MateriaTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MateriaTableMap::translateFieldName('CarId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->car_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MateriaTableMap::translateFieldName('Descripcion', TableMap::TYPE_PHPNAME, $indexType)];
            $this->descripcion = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MateriaTableMap::translateFieldName('Observacion', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = MateriaTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Materia'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMateriaQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Materia::setDeleted()
     * @see Materia::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMateriaQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MateriaTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MateriaTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(MateriaTableMap::COL_CAR_ID)) {
            $modifiedColumns[':p' . $index++]  = 'car_id';
        }
        if ($this->isColumnModified(MateriaTableMap::COL_DESCRIPCION)) {
            $modifiedColumns[':p' . $index++]  = 'descripcion';
        }
        if ($this->isColumnModified(MateriaTableMap::COL_OBSERVACION)) {
    ...
    {
        $pos = MateriaTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Materia'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Materia'][$this->hashCode()] = true;
        $keys = MateriaTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setObservacion($arr[$keys[3]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MateriaTableMap::COL_ID)) {
            $criteria->add(MateriaTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(MateriaTableMap::COL_CAR_ID)) {
            $criteria->add(MateriaTableMap::COL_CAR_ID, $this->car_id);
        }
        if ($this->isColumnModified(MateriaTableMap::COL_DESCRIPCION)) {
            $criteria->add(MateriaTableMap::COL_DESCRIPCION, $this->descripcion);
        }
        if ($this->isColumnModified(MateriaTableMap::COL_OBSERVACION)) {
            $criteria->add(MateriaTableMap::COL_OBSERVACION, $this->observacion);
        }
    ...
    {
        $criteria = ChildMateriaQuery::create();
        $criteria->add(MateriaTableMap::COL_ID, $this->id);
     ...
     * If this ChildMateria is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildMateria The current object (for fluent API support)
     */
     ...
     * @return ObjectCollection|ChildExamen[] List of ChildExamen objects
     */
    public function getExamensJoinPeriodo(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildExamenQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aCarrera) {
            $this->aCarrera->removeMateria($this);
        }
        $this->id = null;
        $this->car_id = null;
    ...
    {
        return (string) $this->exportTo(MateriaTableMap::DEFAULT_STRING_FORMAT);
    }
