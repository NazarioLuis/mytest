...
abstract class Usuario implements ActiveRecordInterface 
{
    ...
    public function setAlias($v)
    {
        ...
        if ($this->alias !== $v) {
            $this->alias = $v;
            $this->modifiedColumns[UsuarioTableMap::COL_ALIAS] = true;
        }
    ...
    public function setSenia($v)
    {
        ...
        if ($this->senia !== $v) {
            $this->senia = $v;
            $this->modifiedColumns[UsuarioTableMap::COL_SENIA] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UsuarioTableMap::translateFieldName('Nombre', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nombre = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UsuarioTableMap::translateFieldName('Alias', TableMap::TYPE_PHPNAME, $indexType)];
            $this->alias = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UsuarioTableMap::translateFieldName('Senia', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsuarioTableMap::COL_ALIAS)) {
            $modifiedColumns[':p' . $index++]  = 'alias';
        }
        if ($this->isColumnModified(UsuarioTableMap::COL_SENIA)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuarioTableMap::COL_ALIAS)) {
            $criteria->add(UsuarioTableMap::COL_ALIAS, $this->alias);
        }
        if ($this->isColumnModified(UsuarioTableMap::COL_SENIA)) {
            $criteria->add(UsuarioTableMap::COL_SENIA, $this->senia);
        }
