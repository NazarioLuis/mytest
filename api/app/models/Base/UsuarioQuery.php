 ...
 * @method     ChildUsuarioQuery orderByAlias($order = Criteria::ASC) Order by the alias column
 * @method     ChildUsuarioQuery orderBySenia($order = Criteria::ASC) Order by the senia column
 *
 ...
 * @method     ChildUsuarioQuery groupByAlias() Group by the alias column
 * @method     ChildUsuarioQuery groupBySenia() Group by the senia column
 *
 ...
 * @method     ChildUsuario findOneByAlias(string $alias) Return the first ChildUsuario filtered by the alias column
 * @method     ChildUsuario findOneBySenia(string $senia) Return the first ChildUsuario filtered by the senia column *
 ...
 * @method     ChildUsuario requireOneByAlias(string $alias) Return the first ChildUsuario filtered by the alias column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUsuario requireOneBySenia(string $senia) Return the first ChildUsuario filtered by the senia column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildUsuario[]|ObjectCollection findByAlias(string $alias) Return ChildUsuario objects filtered by the alias column
 * @method     ChildUsuario[]|ObjectCollection findBySenia(string $senia) Return ChildUsuario objects filtered by the senia column
...
abstract class UsuarioQuery extends ModelCriteria
{
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = UsuarioTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT id, nombre, alias, senia FROM usuario WHERE id = :p0';
        try {
    ...
    public function filterByAlias($alias = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UsuarioTableMap::COL_ALIAS, $alias, $comparison);
    }
    ...
    public function filterBySenia($senia = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UsuarioTableMap::COL_SENIA, $senia, $comparison);
    }
