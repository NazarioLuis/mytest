...
abstract class Inscripcion implements ActiveRecordInterface 
{
    ...
    public function setPerId($v)
    {
        ...
        if ($this->per_id !== $v) {
            $this->per_id = $v;
            $this->modifiedColumns[InscripcionTableMap::COL_PER_ID] = true;
        }
    ...
    public function setAluId($v)
    {
        ...
        if ($this->alu_id !== $v) {
            $this->alu_id = $v;
            $this->modifiedColumns[InscripcionTableMap::COL_ALU_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : InscripcionTableMap::translateFieldName('PerId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(InscripcionTableMap::COL_PER_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InscripcionTableMap::COL_PER_ID)) {
            $criteria->add(InscripcionTableMap::COL_PER_ID, $this->per_id);
        }
        if ($this->isColumnModified(InscripcionTableMap::COL_ALU_ID)) {
    ...
    public function hashCode()
    {
        ...
        //relation alumnos_periodos_detalle_fk to table alumno
        ...
        //relation periodos_periodos_detalle_fk to table periodo
        if ($this->aPeriodo && $hash = spl_object_hash($this->aPeriodo)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }
    ...
    {
        return (null === $this->getPerId()) && (null === $this->getAluId());
    }
    ...
    public function getAlumno(ConnectionInterface $con = null)
    {
        if ($this->aAlumno === null && ($this->alu_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAlumno->addInscripcions($this);
             */
        }
    ...
    public function getPeriodo(ConnectionInterface $con = null)
    {
        if ($this->aPeriodo === null && ($this->per_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPeriodo->addInscripcions($this);
             */
        }
    ...
    {
        if (null !== $this->aAlumno) {
            $this->aAlumno->removeInscripcion($this);
        }
        if (null !== $this->aPeriodo) {
            $this->aPeriodo->removeInscripcion($this);
        }
        $this->per_id = null;
        $this->alu_id = null;
        $this->orden = null;
