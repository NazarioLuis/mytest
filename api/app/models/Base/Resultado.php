...
*/
abstract class Resultado implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ResultadoTableMap';
    ...
    /**
     * Initializes internal state of Base\Resultado object.
     */
    ...
    /**
     * Compares this with another <code>Resultado</code> instance.  If
     * <code>obj</code> is an instance of <code>Resultado</code>, delegates to
     * <code>equals(Resultado)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     * @return $this|\Resultado The current object (for fluent API support)
     */
    public function setExaId($v)
    {
        ...
        if ($this->exa_id !== $v) {
            $this->exa_id = $v;
            $this->modifiedColumns[ResultadoTableMap::COL_EXA_ID] = true;
        }
    ...
    public function setAluId($v)
    {
        ...
        if ($this->alu_id !== $v) {
            $this->alu_id = $v;
            $this->modifiedColumns[ResultadoTableMap::COL_ALU_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ResultadoTableMap::translateFieldName('ExaId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->exa_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ResultadoTableMap::translateFieldName('AluId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = ResultadoTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Resultado'), 0, $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aAlumno !== null && $this->alu_id !== $this->aAlumno->getId()) {
            $this->aAlumno = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildResultadoQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Resultado::setDeleted()
     * @see Resultado::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildResultadoQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ResultadoTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ResultadoTableMap::COL_EXA_ID)) {
            $modifiedColumns[':p' . $index++]  = 'exa_id';
        }
        if ($this->isColumnModified(ResultadoTableMap::COL_ALU_ID)) {
    ...
    {
        $pos = ResultadoTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Resultado'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Resultado'][$this->hashCode()] = true;
        $keys = ResultadoTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getExaId(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aAlumno) {
                ...
                $result[$key] = $this->aAlumno->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ResultadoTableMap::COL_EXA_ID)) {
            $criteria->add(ResultadoTableMap::COL_EXA_ID, $this->exa_id);
        }
        if ($this->isColumnModified(ResultadoTableMap::COL_ALU_ID)) {
            $criteria->add(ResultadoTableMap::COL_ALU_ID, $this->alu_id);
        }
    ...
    {
        $criteria = ChildResultadoQuery::create();
        $criteria->add(ResultadoTableMap::COL_EXA_ID, $this->exa_id);
        $criteria->add(ResultadoTableMap::COL_ALU_ID, $this->alu_id);
    ...
    {
        $validPk = null !== $this->getExaId() &&
            null !== $this->getAluId();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation alumnos_resultados_fk to table alumno
        if ($this->aAlumno && $hash = spl_object_hash($this->aAlumno)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }

        //relation examenes_resultados_fk to table examen
    ...
    {
        $this->setExaId($keys[0]);
        $this->setAluId($keys[1]);
    }
    ...
    {
        return (null === $this->getExaId()) && (null === $this->getAluId());
    }
    ...
    /**
     * Declares an association between this object and a ChildAlumno object.
     *
     * @param  ChildAlumno $v
     * @return $this|\Resultado The current object (for fluent API support)
     * @throws PropelException
     */
    public function setAlumno(ChildAlumno $v = null)
    {
        if ($v === null) {
            $this->setAluId(NULL);
        } else {
            $this->setAluId($v->getId());
        }

        $this->aAlumno = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildAlumno object, it will not be re-added.
        if ($v !== null) {
            $v->addResultado($this);
        }
    ...
    /**
     * Get the associated ChildAlumno object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildAlumno The associated ChildAlumno object.
     * @throws PropelException
     */
    public function getAlumno(ConnectionInterface $con = null)
    {
        if ($this->aAlumno === null && ($this->alu_id !== null)) {
            $this->aAlumno = ChildAlumnoQuery::create()->findPk($this->alu_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAlumno->addResultados($this);
             */
        }
    ...
    public function getExamen(ConnectionInterface $con = null)
    {
        if ($this->aExamen === null && ($this->exa_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aExamen->addResultados($this);
             */
        }
     ...
     * If this ChildResultado is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildResultado The current object (for fluent API support)
     */
    public function setResultadoDetalles(Collection $resultadoDetalles, ConnectionInterface $con = null)
    {
        ...
        foreach ($resultadoDetallesToDelete as $resultadoDetalleRemoved) {
            $resultadoDetalleRemoved->setResultado(null);
        }
    ...
    protected function doAddResultadoDetalle(ChildResultadoDetalle $resultadoDetalle)
    {
        ...
        $resultadoDetalle->setResultado($this);
    }
    ...
    public function removeResultadoDetalle(ChildResultadoDetalle $resultadoDetalle)
    {
        if ($this->getResultadoDetalles()->contains($resultadoDetalle)) {
            ...
            $resultadoDetalle->setResultado(null);
        }
     ...
     * @return ObjectCollection|ChildResultadoDetalle[] List of ChildResultadoDetalle objects
     */
    public function getResultadoDetallesJoinPregunta(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildResultadoDetalleQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aAlumno) {
            $this->aAlumno->removeResultado($this);
        }
        if (null !== $this->aExamen) {
            $this->aExamen->removeResultado($this);
        }
        $this->exa_id = null;
        $this->alu_id = null;
        $this->alreadyInSave = false;
    ...
    {
        return (string) $this->exportTo(ResultadoTableMap::DEFAULT_STRING_FORMAT);
    }
